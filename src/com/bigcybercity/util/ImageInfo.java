...
/*	private String readLine(int firstChar) throws IOException {
    ...
    public short[] scaleImage(String file) {
        short[] dim = new short[2];
        try {
            FileInputStream in = new FileInputStream("/usr/local/www/apache22/data" + file);
            setInput(in);
            if(check()) {
                dim[0] = (short)(210 * ((float)getWidth()/(float)getHeight()));
                dim[1] = 210;
                if(dim[0] > 270) dim[0] = 270;
            }
            in.close();
        } catch(IOException e) {
            dim[0] = 270;
    ...
    public short[] scaleImageSmall(String file) {
        short[] dim = new short[2];
        try {
            FileInputStream in = new FileInputStream("/usr/local/www/apache22/data" + file);
            setInput(in);
            if(check()) {
                dim[0] = (short)(100 * ((float)getWidth()/(float)getHeight()));
                dim[1] = 100;
                if(dim[0] > 129) dim[0] = 129;
            }
            in.close();
        } catch(IOException e) {
            dim[0] = 129;
    ...
    public short[] scaleImageMed(String file) {
        short[] dim = new short[2];
        try {
            FileInputStream in = new FileInputStream("/usr/local/www/apache22/data" + file);
            setInput(in);
            if(check()) {
                dim[0] = (short)(167 * ((float)getWidth()/(float)getHeight()));
                dim[1] = 167;
                if(dim[0] > 215) dim[0] = 215;
            }
            in.close();
        } catch(IOException e) {
            dim[0] = 215;
    ...
    public short[] scaleImageFull(String file) {
        short[] dim = new short[2];
        try {
            FileInputStream in = new FileInputStream("/usr/local/www/apache22/data" + file);
            setInput(in);
            if(check()) {
                if(getWidth() > 890) {
                dim[0] = (short)(691 * ((float)getWidth()/(float)getHeight()));
                dim[1] = 691;
                if(dim[0] > 890) dim[0] = 890;
                } else {
                    dim[0] = (short)getWidth();
                    dim[1] = (short)getHeight();
                }
            }
            in.close();
        } catch(IOException e) {
